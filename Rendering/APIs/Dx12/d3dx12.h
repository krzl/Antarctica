...
struct CD3DX12_RESOURCE_DESC : public D3D12_RESOURCE_DESC
{
    ...
    inline UINT CalcSubresource(UINT MipSlice, UINT ArraySlice, UINT PlaneSlice) const noexcept
...
struct DefaultSampleMask { operator UINT() const noexcept { return UINT_MAX; } };
struct DefaultSampleDesc { operator DXGI_SAMPLE_DESC() const noexcept { return DXGI_SAMPLE_DESC{1, 0}; } };
...
public:
    ...
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT& operator=(const InnerStructType& i) noexcept { _Type = Type; _Inner = i; return *this; }
