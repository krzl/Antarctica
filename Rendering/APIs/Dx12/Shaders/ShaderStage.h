...
namespace Rendering::Dx12
{
	...
	public:
		...
		[[nodiscard]] const D3D12_SHADER_DESC& GetDescriptor() const { return m_descriptor; }

		[[nodiscard]] ID3D12ShaderReflection* GetReflector() const { return m_reflector.Get(); }

		[[nodiscard]] bool IsCompiled() const { return m_byteCode != nullptr; }

		[[nodiscard]] const ComPtr<ID3DBlob>& GetByteCode() const { return m_byteCode; }
